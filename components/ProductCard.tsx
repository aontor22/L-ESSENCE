...
const ProductCard: React.FC<ProductCardProps> = ({ perfume, index, onAddToCart, isWishlisted, onToggleWishlist }) => {
            ...
            <div className="flex items-center justify-between mt-4 border-t border-white/10 pt-4">
                ...
                <div className="flex gap-2">
                    ...
                    <button 
                        ...
                        className={`border ${isWishlisted ? 'border-[#D4AF37] text-[#D4AF37]' : 'border-white/20 text-white'} p-2 hover:bg-white hover:text-black hover:border-white transition-colors duration-300`}
                        ...
                        <div className="pt-6 md:pt-8 border-t border-white/10 flex flex-col gap-4">
                            <div className="flex gap-4">
                                ...
                                <button 
                                    ...
                                    className={`px-6 border transition-colors flex items-center justify-center ${isWishlisted ? 'border-[#D4AF37] text-[#D4AF37]' : 'border-white/20 text-white hover:border-[#D4AF37] hover:text-[#D4AF37]'}`}
                                >
